...
class ASPP(nn.Module):
    def __init__(self, c1, c2, k):
        ...
        self.atrous_block1 = nn.Conv2d(c1, c2, 1, 1)
        self.atrous_block6 = nn.Conv2d(c1, c2, 3, 1, padding=6, dilation=6)
        self.atrous_block12 = nn.Conv2d(c1, c2, 3, 1, padding=12, dilation=12)
        self.atrous_block18 = nn.Conv2d(c1, c2, 3, 1, padding=18, dilation=18)
        self.conv_1x1_output = Conv(c2 * 5, c2, 1, 1)
...
# https://cloud.tencent.com/developer/article/2365900
